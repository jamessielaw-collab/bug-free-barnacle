  ...
  return (
    <footer className="relative bg-gradient-to-b from-charcoal to-black text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        >
          <h3
            className="font-playfair text-xl sm:text-2xl md:text-3xl mb-2 md:mb-3"
            style={{ color: "#c5bbaf" }}
          >
            Stay Connected
          </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 lg:gap-12 mb-8 md:mb-12">
          ...
          >
            <h3
              className="font-playfair text-xs sm:text-sm uppercase tracking-widest mb-4 md:mb-6"
              style={{ color: "#c5bbaf" }}
            >
              Navigate
            </h3>
          ...
          >
            ...
            <p className="text-stone-400 text-xs mt-3 md:mt-4">@careyyman</p>
          </motion.div>
        </div>
